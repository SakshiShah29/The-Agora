export const AGENT_CONVERSION_CONFIG: Record<string, {
 ...
 export const AGENT_INFO: Record<number, { name: string; belief: string; beliefId: number }> = {
  1: { name: "Camus",    belief: "defiant-absurdism",         beliefId: 2 },
  2: { name: "Dread",    belief: "contemplative-absurdism",   beliefId: 2 },
  3: { name: "Epicteta", belief: "practical-stoicism",        beliefId: 4 },
  4: { name: "Kael",     belief: "radical-existentialism",    beliefId: 3 },
  5: { name: "Nihilo",   belief: "constructive-nihilism",     beliefId: 1 },
  6: { name: "Seneca",   belief: "classical-stoicism",        beliefId: 4 },
  7: { name: "Sera",     belief: "reflective-existentialism", beliefId: 3 },
  8: { name: "Voyd",     belief: "passive-nihilism",          beliefId: 1 },
};

 // ─── Default belief state ────────────────────────────────────────────────────
export const AGENT_DEFAULTS: Record<string, any> = {
  "1": { agent: "camus",    agentName: "Camus",    agentId: 1, coreBeliefId: 2, beliefName: "defiant-absurdism",         currentBelief: "defiant-absurdism",         conviction: 87 },
  "2": { agent: "dread",    agentName: "Dread",     agentId: 2, coreBeliefId: 2, beliefName: "contemplative-absurdism",   currentBelief: "contemplative-absurdism",   conviction: 82 },
  ...
  "4": { agent: "kael",     agentName: "Kael",      agentId: 4, coreBeliefId: 3, beliefName: "radical-existentialism",    currentBelief: "radical-existentialism",    conviction: 85 },
  ...
  "7": { agent: "sera",     agentName: "Sera",      agentId: 7, coreBeliefId: 3, beliefName: "reflective-existentialism", currentBelief: "reflective-existentialism", conviction: 78 },
